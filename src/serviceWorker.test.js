...
describe("checkValidServiceWorker", () => {
    ...
    test("3", () => {
        let callFunction = () => {
            checkValidServiceWorker("http://www.example.com/route/123?foo=bar", "png.mpg4")
        }
    ...
    test("4", () => {
        let callFunction = () => {
            checkValidServiceWorker("https://accounts.google.com/o/oauth2/revoke?token=%s", "arizona_extend.wav")
        }
